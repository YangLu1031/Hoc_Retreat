...
<%	
	...
	{
		hocWhereString = hoc.trim();
	}
	IDataPersistManager dpm = new DataPersistManagerImpl();
    List<Participant> participants = dpm.findEntitiesByHocFamily(hocWhereString); 
    List<ParticipantNotes> notes = dpm.findEntitiesByConfId(null, ParticipantNotes.class);
