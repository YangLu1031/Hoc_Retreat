...
@WebServlet(
	    ...
	    urlPatterns = {"/SubmitRegistration"}
	)
public class SubmitRegistrationServlet extends HttpServlet {
	...
	private static final String default_email = "hocjointevents@gmail.com";	//"no-reply@hoc-retreat-us.appspotmail.com"; 
								//bpan: used for google appengine login
	private static final String default_admin_email = "hocjointevents@gmail.com"; 
		...
		String confirm_no = null;
		{
			...
			{ 
		        ...
		        if (isAdminModify) {
		    		...
		    		try {
		    		    List<Participant> partis = dpm.findEntitiesByConfId(confirmationNumber, Participant.class);
			        	int dn = 0;	//counter
		    		...
		    		try {
		    		    ...
		    		    List<ParticipantNotes> delnotes = dpm.findEntitiesByConfId(confirmationNumber, ParticipantNotes.class);
		    		    int dn = 0;	//counter
