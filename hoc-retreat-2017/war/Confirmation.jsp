...
<title>HOC Retreat 2017 - 確認</title>
	...
	if (participants != null ) 
	{
		for ( int i = 0; i < participants.size() ; i++ )
		{
			...
			if ( 	participant != null )
			{
				...
				switch(pcode) {
					case '1': stopic = "李智群牧師 ／ 為耶路撒冷求平安!"; break;
					case '2': stopic = "赵约翰牧师，赵恩慈师母 ／ 家庭婚姻专题：在主爱中成长 ，在盼望中合一"; break;
					case '3': stopic = "程陽傑長老 ／ 基督徒职场生活"; break;
					case '4': stopic = "陳少豪弟兄 ／ 財經講座:天國投資"; break;
