...
<title>HOC Retreat 2017 - Retrieved Registration Page</title>
...
{ 
 ...
 if (which == "N" || which =="S" || which =="F" || which =="T" || which =="B"|| which =="P"  )
 {
  ...
  else
  {
      ...
      var vList = ["重症病人的關懷與輔導","基督徒的事業與事奉","親子關係  親子沟通","基督徒正確的財富觀念","新舊約聖經的研讀","English Youth Program","English Adult Program","未定 Undecided"];
...
<div id="FormBlock">
<font size="1">&nbsp;<br /></font>
<span style="font-weight:bold; font-size:24px;">2017 退修會報名表 Retreat Registration Form</span>
<% 
