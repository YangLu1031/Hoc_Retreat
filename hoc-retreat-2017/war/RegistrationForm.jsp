...
<title>HOC Retreat 2017 - Registration Page</title>
 ...
 if (which == "N" || which =="S" || which =="F" || which =="T" || which =="B" || which =="R")
 {
  ...
  else
  {
	// array of possible countries in the same order as they appear in the country selection list 
	  var vList = ["為耶路撒冷求平安!","家庭婚姻专题：在主爱中成长 ，在盼望中合一","基督徒职场生活","財經講座:天國投資","English Youth Program","English Adult Program","未定 Undecided"];
...
<div id="container">
<div id="header">
<h1><strong>2017 基督之家聯合退修會報名</strong></h1>
<br />
...
%>
  ...
  <tr>
    <td style="font-size:18px; font-weight:bold; padding-left:8px;">報名截止日期 Registration Deadline: 6/30/2017<br />
...
<table width="100%" border="0" cellspacing="5" cellpadding="3">
  <tr>
    <td width="33%" align="left" valign="middle"><div id="reg-general-title"> 2017 Summer Retreat</div></td>
...
www.sonoma.edu/cec </td>
    ...
    <div id="reg-chinese-body" class="infoBody">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="83" rowspan="3" valign="top"><img src="images/laijianguo.png" alt="" width="80"/></td>
        <td valign="top">中文主題
        	</td>
      </tr>
      <tr>
        <td valign="top"><span style="font-size:large; font-weight:bold; color:blue;">高舉基督，傳揚真理(主題經文：約二十31)</span></td>
      </tr>
      <tr>
      <td valign="top">主題講員：賴建國牧師</td>
      </tr>
      </table>
      <div class="speakerName">&nbsp;<br /><span style="font-size:9px;">&nbsp;</span></div>
      <table width="100%" border="1" cellspacing="0" cellpadding="1">
        ...
        <tr>
          <td>1.</td>
          <td><span class="ClassItem">李智群牧師 - 為耶路撒冷求平安!</span></td>
        </tr>
        <tr>
          <td>2.</td>
          <td><span class="ClassItem">赵约翰牧师，赵恩慈师母 - 家庭婚姻专题：在主爱中成长 ，在盼望中合一</span></td>
        </tr>
        <tr>
          <td>3.</td>
          <td><span class="ClassItem">程陽傑長老 - 基督徒职场生活</span></td>
        </tr>  
        <tr>
           <td>4.</td>
          <td><span class="ClassItem">陳少豪弟兄 - 財經講座:天國投資</span></td>
        </tr>
      </table>
<br />
    ...
    <td valign="top"><div id="reg-english-body" class="infoBody">
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="83" rowspan="3" valign="top"><img src="images/RussellJeung.jpg" alt="" width="80" /></td>
        <td valign="top">Theme: 
        	</td>
      </tr>
      <tr>
        <td valign="top"><span style="font-size:large; font-weight:bold; color:blue;">Exilic Identity of Christ</span></td>
      </tr>
      <tr>
      <td valign="top">Speaker: Mr. Russell Jeung</td>
      </tr>
      </table>
			<!--
        <div class="speakerName">&nbsp;<br /><span style="font-size:9px;">&nbsp;</span></div>
...
<span style="font-weight:bold; font-size:24px;">2017 退修會網路報名表 Online Retreat Registration Form</span>
	...
	<TBODY>
		...
		<TR>
			...
			<TH align="center" valign="middle"><select name="Topic_<%=i%>"
				size="1" id="Topic_<%=i%>">
			  <option></option>
		    <option value="1">為耶路撒冷求平安!</option>
			  <option value="2">家庭婚姻专题：在主爱中成长 ，在盼望中合一</option>
			  <option value="3">基督徒职场生活</option>
			  <option value="4">財經講座:天國投資</option>
			  <option value="6">English Youth Program</option>
			  <option value="7">English Adult Program</option>
			  <option value="8">未定 Undecided</option>
...
%>
		...
		<OPTION value="1" <%=T1%>>為耶路撒冷求平安!</OPTION>
		<OPTION value="2" <%=T2%>>家庭婚姻专题：在主爱中成长 ，在盼望中合一</OPTION>
		<OPTION value="3" <%=T3%>>基督徒职场生活</OPTION>
		<OPTION value="4" <%=T4%>>財經講座:天國投資</OPTION>
		<OPTION value="6" <%=T6%>>English Youth Program</OPTION>
	  	<option value="7" <%=T7%>>English Adult Program</option>
	  	<option value="8" <%=T8%>>未定 Undecided</option>
<%
				}
%>
...
<TABLE border="0" cellpadding="3" cellspacing="0">
		...
		<TR>
		  <TD align="left" valign="top">1.</TD>
          <td><strong>報名費用</strong>：<span lang="ZH-TW" xml:lang="ZH-TW">2017年7月16日以前未滿</span><span lang="ZH-CN" xml:lang="ZH-CN">四</span><span lang="ZH-TW" xml:lang="ZH-TW">歲者</span>免費。四歲至十一歲不佔床位者 $90；佔床位者  $170。12歲以上者 $170。各家自行設定折扣方式。預估實際支出每人$230。 報名截止日期6/30/2017，先到先得，額滿即止。 <span class="font-red"></strong></TD>
	  </TR>
		<TR>
		  <TD align="left" valign="top">&nbsp;</TD>
          <td><span title=""><strong>Registration Fee</strong>: Children below 4 years of age before 7/16/2017, FREE. From 4 years to 11 years but occupying a bed, $170 (not occupying a bed, $90). Twelve years and above, $170. Estimated actual expenditures per person $230. Registration deadline 6/30/2017, on a first-come, first-served basis. </span></TD>
	  </TR>
		<TR>
		  <TD align="left" valign="top">2.</TD>
